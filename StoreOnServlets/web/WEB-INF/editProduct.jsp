...
<div class="container">
  ...
  <form action="/edit" method="post" class="form-horizontal" accept-charset="UTF-8">
    <div class="form-group">
      <label class="col-sm-2 control-label">Животное:</label>

      <div class="col-sm-6">
        <input type="text" class="form-control" name="pet" placeholder="Животное" value="<%out.print(product.getPet());%>">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" name="type" placeholder="Тип товара" value="<%=product.getTypeOfProduct()%>">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" name="nameOfProduct" placeholder="Название" value="<%=product.getNameOfProduct()%>">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <textarea class="form-control" rows="3" name="description" placeholder="Описание"><%=product.getDescription()%></textarea>
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" name="price" placeholder="Цена" value="<%=product.getPrice()%>">
      </div>
    </div>
    <div class="form-group">
  ...
  <%
    ...
    if (log == null) {
      ...
      if (log.equals("true")) {%>
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <h3><span class="label label-default">Товар изменен</span></h3>
            </div>
          </div>
