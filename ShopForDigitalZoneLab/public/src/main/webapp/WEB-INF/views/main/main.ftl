    ...
    <div class="container">
        <div class="arriv-top">
            <div class="col-md-6 arriv-left">
                ...
                <div class="arriv-info">
                    ...
                    <div class="crt-btn">
                        <a href="/catalog/all">TAKE A LOOK</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 arriv-right">
                ...
                <div class="arriv-info">
                    ...
                    <p>REVIVE YOUR WARDROBE WITH CHIC KNITS</p>
                    <div class="crt-btn">
                        <a href="/catalog/tuxedo">SHOP NOW</a>
                    </div>
                </div>
            </div>
        ...
        <div class="arriv-bottm">
            <div class="col-md-8 arriv-left1">
                ...
                <div class="arriv-info1">
                    ...
                    <p>REVIVE YOUR WARDROBE WITH CHIC KNITS</p>
                    <div class="crt-btn">
                        <a href="/catalog/sweater">SHOP NOW</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 arriv-right1">
                ...
                <div class="arriv-info2">
                    <a href="/catalog/shoes"><h3>Trekking Shoes<i class="ars"></i></h3></a>
                </div>
            </div>
            <div class="clearfix"> </div>
        </div>
        <div class="arriv-las">
            <div class="col-md-4 arriv-left2">
                ...
                <div class="arriv-info2">
                    <a href="/catalog/glasses"><h3>Casual Glasses<i class="ars"></i></h3></a>
                </div>
            </div>
            <div class="col-md-4 arriv-middle">
                ...
                <div class="arriv-info3">
                    ...
                    <div class="crt-btn">
                        <a href="/catalog/t-shirt">SHOP NOW</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 arriv-right2">
                ...
                <div class="arriv-info2">
                    <a href="/catalog/watches"><h3>Elegant Watches<i class="ars"></i></h3></a>
                </div>
            </div>
            <div class="clearfix"> </div>
        </div>
...
<div class="special">
    <div class="container">
        ...
        <div class="specia-top">
            <ul class="grid_2">
                <li>
                    <a href="../html/details.html"><img src="/resources/images/8.jpg" class="img-responsive" alt=""></a>
                ...
                <li>
                    <a href="../html/details.html"><img src="/resources/images/9.jpg" class="img-responsive" alt=""></a>
                    <div class="special-info grid_1 simpleCart_shelfItem">
                ...
                <li>
                    <a href="../html/details.html"><img src="/resources/images/10.jpg" class="img-responsive" alt=""></a>
                    <div class="special-info grid_1 simpleCart_shelfItem">
                ...
                <li>
                    <a href="../html/details.html"><img src="/resources/images/11.jpg" class="img-responsive" alt=""></a>
                    <div class="special-info grid_1 simpleCart_shelfItem">
